package company.eckel.containers;//: containers/Stacks.java
...
public class Stacks {
  public static void main(String[] args) {
    ...
    company.eckel.net.mindview.util.Stack<String> stack2 =
      new company.eckel.net.mindview.util.Stack<String>();
    for(Month m : Month.values())
