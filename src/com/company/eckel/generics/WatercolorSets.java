package company.eckel.generics;//: generics/WatercolorSets.java

import company.eckel.generics.watercolors.Watercolors;
import java.util.*;

import static company.eckel.generics.Sets.*;
